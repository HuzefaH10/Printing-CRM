    ...
    <div className="flex flex-col h-full space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground mt-2">
            Manage your production and associated records here.
          </p>
        </div>
      ...
      <div className="flex flex-col items-center justify-center flex-1 border rounded-lg border-dashed bg-card/50">
        <div className="flex flex-col items-center justify-center text-center p-8 max-w-sm">
          ...
          <h3 className="text-xl font-semibold mb-2">No production found</h3>
          <p className="text-sm text-muted-foreground mb-6">
            You don't have any production yet. Create your first one to get started with the new OS.
          </p>
